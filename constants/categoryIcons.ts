...
export const CATEGORY_ICONS: Record<string, any> = {
  ...
  "Bakery, Cakes & Dairy": require("@/assets/images/categories/Bakery, Cakes and Dairy.webp"),
  Books: require("@/assets/images/categories/Books.webp"),
  "Chicken, Meat & Fish": require("@/assets/images/categories/Chicken, Meat and Fish.webp"),
  "Construction Material": require("@/assets/images/categories/Construction Material.webp"),
  "Decor & Gifting": require("@/assets/images/categories/Decor and Gifting.webp"),
  Diagnostic: require("@/assets/images/categories/Diagnostic.webp"),
  "Dry Fruits & Cereals": require("@/assets/images/categories/Dry Fruits and Cereals.webp"),
  "Electronics & Appliances": require("@/assets/images/categories/Electronics and Appliances.webp"),
  "Fabric Care": require("@/assets/images/categories/Fabric Care.webp"),
  "Fitness & Sports": require("@/assets/images/categories/Fitness and Sports.webp"),
  "Food & Beverage": require("@/assets/images/categories/Food and Beverage.webp"),
  "Fruits & Vegetables": require("@/assets/images/categories/Fruits and Vegetables.webp"),
  "Garden & Farm": require("@/assets/images/categories/Garden and Farm.webp"),
  "Glam & Beauty": require("@/assets/images/categories/Glam and Beauty.webp"),
  Grocery: require("@/assets/images/categories/Grocery.webp"),
  "Handbags & Clutches": require("@/assets/images/categories/Handbags and Clutches.webp"),
  "Health & Pharma": require("@/assets/images/categories/Health and Pharma.webp"),
  ...
  "Makeup & Beauty": require("@/assets/images/categories/Makeup and Beauty.webp"),
  "Music, Dance & Arts": require("@/assets/images/categories/Music, Dance and Arts.webp"),
  ...
  "Snacks & Drinks": require("@/assets/images/categories/Snacks and Drinks.webp"),
  "Sports Store": require("@/assets/images/categories/Sports Store.webp"),
  "Stationery & Games": require("@/assets/images/categories/Stationery and Games.webp"),
...
export const getCategoryIcon = (categoryName: string) => {
  ...
  if (CATEGORY_ICONS[trimmedName]) {
    return CATEGORY_ICONS[trimmedName];
  }
  ...
  // Try partial match (for cases like "Fruits" matching "Fruits and Vegetables")
  for (const [key, value] of Object.entries(CATEGORY_ICONS)) {
    if (key.toLowerCase().startsWith(lowerCategoryName)) {
      return value;
    }
  }
...
export const SUBCATEGORY_ICONS: Record<string, any> = {
  ...
  "Aerobics and Zumba": require("@/assets/images/categories/SubCategories/Aerobics and Zumba.webp"),
  ...
  "Atta, Rice and Dal": require("@/assets/images/categories/SubCategories/Atta, Rice and Dal.webp"),
  ...
  "Bags & School Needs": require("@/assets/images/categories/SubCategories/Bags and School Needs.webp"),
  ...
  "Bathroom & Kitchen Fittings": require("@/assets/images/categories/SubCategories/Bathroom and Kitchen Fittings.webp"),
  ...
  "Besan, Sooji and Maida": require("@/assets/images/categories/SubCategories/Besan, Sooji and Maida.webp"),
  ...
  "Biscuits and Cookies": require("@/assets/images/categories/SubCategories/Biscuits and Cookies.webp"),
  Blinds: require("@/assets/images/categories/SubCategories/Blinds.webp"),
  "Body Lotion and Oils": require("@/assets/images/categories/SubCategories/Body Lotion and Oils.webp"),
  "Bread, Pav and Kulcha": require("@/assets/images/categories/SubCategories/Bread, Pav and Kulcha.webp"),
  Bread: require("@/assets/images/categories/SubCategories/Bread.webp"),
  "Bricks and Blocks": require("@/assets/images/categories/SubCategories/Bricks and Blocks.webp"),
  "Buns and Pav": require("@/assets/images/categories/SubCategories/Buns and Pav.webp"),
  ...
  "Butter and Cheese": require("@/assets/images/categories/SubCategories/Butter and Cheese.webp"),
  Cafe: require("@/assets/images/categories/SubCategories/Cafe.webp"),
  "Cakes and Pastries": require("@/assets/images/categories/SubCategories/Cakes and Pastries.webp"),
  "Cassata and Sandwich": require("@/assets/images/categories/SubCategories/Cassata and Sandwich.webp"),
  ...
  "Chargers and Cables": require("@/assets/images/categories/SubCategories/Chargers and Cables.webp"),
  ...
  "Chips and Namkeen": require("@/assets/images/categories/SubCategories/Chips and Namkeen.webp"),
  ...
  "Coffee and Tea": require("@/assets/images/categories/SubCategories/Coffee and Tea.webp"),
  ...
  "Curd, Yogurt and lassi": require("@/assets/images/categories/SubCategories/Curd, Yogurt and lassi.webp"),
  "Curd,Yogurt and Lassi": require("@/assets/images/categories/SubCategories/Curd,Yogurt and Lassi.webp"),
  ...
  "Daipers and Wipes": require("@/assets/images/categories/SubCategories/Daipers and Wipes.webp"),
  ...
  "Drinks and Juices": require("@/assets/images/categories/SubCategories/Drinks and Juices.webp"),
  ...
  "Earphones and Headsets": require("@/assets/images/categories/SubCategories/Earphones and Headsets.webp"),
  ...
  "Files and Office Needs": require("@/assets/images/categories/SubCategories/Files and Office Needs.webp"),
  "Fish and Sea Food": require("@/assets/images/categories/SubCategories/Fish and Sea Food.webp"),
  Florist: require("@/assets/images/categories/SubCategories/Florist.webp"),
  "Football and Volleyball": require("@/assets/images/categories/SubCategories/Football and Volleyball.webp"),
  ...
  "Glue and Tape": require("@/assets/images/categories/SubCategories/Glue and Tape.webp"),
  ...
  "Honey & Chyawanprash": require("@/assets/images/categories/SubCategories/Honey and Chyawanprash.webp"),
  ...
  "Jam and Spreads": require("@/assets/images/categories/SubCategories/Jam and Spreads.webp"),
  ...
  "Laptop and Mobile Phones": require("@/assets/images/categories/SubCategories/Laptop and Mobile Phones.webp"),
  ...
  "Milk and Eggs": require("@/assets/images/categories/SubCategories/Milk and Eggs.webp"),
  "Milk Bottle and Accessories": require("@/assets/images/categories/SubCategories/Milk Bottle and Accessories.webp"),
  "Mobile and Computer": require("@/assets/images/categories/SubCategories/Mobile and Computer.webp"),
  ...
  "Notebooks and Diaries": require("@/assets/images/categories/SubCategories/Notebooks and Diaries.webp"),
  Nursery: require("@/assets/images/categories/SubCategories/Nursery.webp"),
  "Oil and Ghee": require("@/assets/images/categories/SubCategories/Oil and Ghee.webp"),
  ...
  "Paneer and Tofu": require("@/assets/images/categories/SubCategories/Paneer and Tofu.webp"),
  ...
  "Pencils, Pens and Markers": require("@/assets/images/categories/SubCategories/Pencils, Pens and Markers.webp"),
  "Perfumes and Gifts set": require("@/assets/images/categories/SubCategories/Perfumes and Gifts set.webp"),
  ...
  "Pet Walkers and Boarding": require("@/assets/images/categories/SubCategories/Pet Walkers and Boarding.webp"),
  "Piano and Keyboard": require("@/assets/images/categories/SubCategories/Piano and Keyboard.webp"),
  ...
  "Poha, Daliya and Other Grains": require("@/assets/images/categories/SubCategories/Poha, Daliya and Other Grains.webp"),
  "Pooja Needs": require("@/assets/images/categories/SubCategories/Pooja Needs.webp"),
  "Pots and Planters": require("@/assets/images/categories/SubCategories/Pots and Planters.webp"),
  ...
  "Radiology and Imaging": require("@/assets/images/categories/SubCategories/Radiology and Imaging.webp"),
  ...
  "Rice and Dal": require("@/assets/images/categories/SubCategories/Rice and Dal.webp"),
  Rugs: require("@/assets/images/categories/SubCategories/Rugs.webp"),
  "Salt and Sugar": require("@/assets/images/categories/SubCategories/Salt and Sugar.webp"),
  "Sand and Aggregates": require("@/assets/images/categories/SubCategories/Sand and Aggregates.webp"),
  ...
  "Sauces and Spreads": require("@/assets/images/categories/SubCategories/Sauces and Spreads.webp"),
  "Sausage, Salami and Ham": require("@/assets/images/categories/SubCategories/Sausage, Salami and Ham.webp"),
  ...
  "Shakes and Coolers": require("@/assets/images/categories/SubCategories/Shakes and Coolers.webp"),
  ...
  "Snacks and Savouries": require("@/assets/images/categories/SubCategories/Snacks and Savouries.webp"),
  Snacks: require("@/assets/images/categories/SubCategories/Snacks.webp"),
  "Soaps and Gel": require("@/assets/images/categories/SubCategories/Soaps and Gel.webp"),
  ...
  "Sports and Gym": require("@/assets/images/categories/SubCategories/Sports and Gym.webp"),
  ...
  "Stoles and Shawls": require("@/assets/images/categories/SubCategories/Stoles and Shawls.webp"),
  ...
  "Supplements and Nourishments": require("@/assets/images/categories/SubCategories/Supplements and Nourishments.webp"),
  "Sweets and Chocolates": require("@/assets/images/categories/SubCategories/Sweets and Chocolates.webp"),
  ...
  "Tea and Coffee": require("@/assets/images/categories/SubCategories/Tea and Coffee.webp"),
  "Tennis and Squash": require("@/assets/images/categories/SubCategories/Tennis and Squash.webp"),
  "TMT Steel Bars": require("@/assets/images/categories/SubCategories/TMT Steel Bars.webp"),
  "Tomato and Chilli Ketchup": require("@/assets/images/categories/SubCategories/Tomato and Chilli Ketchup.webp"),
  "Toys and Accessories": require("@/assets/images/categories/SubCategories/Toys and Accessories.webp"),
  "Toys and Games": require("@/assets/images/categories/SubCategories/Toys and Games.webp"),
  Treats: require("@/assets/images/categories/SubCategories/Treats.webp"),
  "Trimmers and Hair Appliances": require("@/assets/images/categories/SubCategories/Trimmers and Hair Appliances.webp"),
  "Tubs and Cups": require("@/assets/images/categories/SubCategories/Tubs and Cups.webp"),
  ...
  "UPVC Door and Windows": require("@/assets/images/categories/SubCategories/UPVC Door and Windows.webp"),
  ...
  "Vitamins and Daily Nutrition": require("@/assets/images/categories/SubCategories/Vitamins and Daily Nutrition.webp"),
  ...
  "Yoga Mat and Yoga Pants": require("@/assets/images/categories/SubCategories/Yoga Mat and Yoga Pants.webp"),
...
export const getSubCategoryIcon = (subCategoryName: string) => {
  ...
  // Try exact match first
  if (SUBCATEGORY_ICONS[trimmedName]) {
    return SUBCATEGORY_ICONS[trimmedName];
  }

  // Try case-insensitive match
  const lowerSubCategoryName = trimmedName.toLowerCase();
  ...
  // Try partial match
  for (const [key, value] of Object.entries(SUBCATEGORY_ICONS)) {
    if (key.toLowerCase().startsWith(lowerSubCategoryName)) {
      return value;
    }
  }
